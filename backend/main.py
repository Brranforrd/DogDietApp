...
from database import insert_dog_questionnaire, get_questionnaire_response  # Import database functions
...
async def submit_dog_info(data: DogQuestionnaireInput):  # Pydantic model automatically validates incoming JSON
    ...
    saves it to the database, calls the report selection logic, and returns the appropriate report.
    """
    try:
        ...
        # Insert questionnaire response into database
        ...
        return {
            ...
            'record_id': db_result['id'],  # Include the database record ID
